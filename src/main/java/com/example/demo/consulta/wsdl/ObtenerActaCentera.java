...
/**
 * <p>Clase Java para obtenerActaCentera complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="obtenerActaCentera"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "obtenerActaCentera", propOrder = {
    "cadena"
})
public class ObtenerActaCentera {
