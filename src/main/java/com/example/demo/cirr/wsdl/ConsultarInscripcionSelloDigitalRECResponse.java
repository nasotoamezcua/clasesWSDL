...
/**
 * <p>Clase Java para consultarInscripcionSelloDigitalRECResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="consultarInscripcionSelloDigitalRECResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "consultarInscripcionSelloDigitalRECResponse", propOrder = {
    "_return"
})
public class ConsultarInscripcionSelloDigitalRECResponse {
