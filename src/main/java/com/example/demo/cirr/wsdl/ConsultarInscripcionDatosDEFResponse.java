...
/**
 * <p>Clase Java para consultarInscripcionDatosDEFResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="consultarInscripcionDatosDEFResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "consultarInscripcionDatosDEFResponse", propOrder = {
    "_return"
})
public class ConsultarInscripcionDatosDEFResponse {
