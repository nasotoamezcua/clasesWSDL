...
/**
 * <p>Clase Java para consultarInscripcionSelloDigitalDEFResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="consultarInscripcionSelloDigitalDEFResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "consultarInscripcionSelloDigitalDEFResponse", propOrder = {
    "_return"
})
public class ConsultarInscripcionSelloDigitalDEFResponse {
