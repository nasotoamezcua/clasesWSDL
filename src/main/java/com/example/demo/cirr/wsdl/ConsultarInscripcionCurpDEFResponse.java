...
/**
 * <p>Clase Java para consultarInscripcionCurpDEFResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="consultarInscripcionCurpDEFResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "consultarInscripcionCurpDEFResponse", propOrder = {
    "_return"
})
public class ConsultarInscripcionCurpDEFResponse {
