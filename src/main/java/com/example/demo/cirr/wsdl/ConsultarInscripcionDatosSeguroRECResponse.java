...
/**
 * <p>Clase Java para consultarInscripcionDatosSeguroRECResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="consultarInscripcionDatosSeguroRECResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "consultarInscripcionDatosSeguroRECResponse", propOrder = {
    "_return"
})
public class ConsultarInscripcionDatosSeguroRECResponse {
