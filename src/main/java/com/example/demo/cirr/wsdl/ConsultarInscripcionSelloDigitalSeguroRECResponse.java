...
/**
 * <p>Clase Java para consultarInscripcionSelloDigitalSeguroRECResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="consultarInscripcionSelloDigitalSeguroRECResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "consultarInscripcionSelloDigitalSeguroRECResponse", propOrder = {
    "_return"
})
public class ConsultarInscripcionSelloDigitalSeguroRECResponse {
