...
/**
 * <p>Clase Java para consultarInscripcionDatosSeguroDEFResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="consultarInscripcionDatosSeguroDEFResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "consultarInscripcionDatosSeguroDEFResponse", propOrder = {
    "_return"
})
public class ConsultarInscripcionDatosSeguroDEFResponse {
