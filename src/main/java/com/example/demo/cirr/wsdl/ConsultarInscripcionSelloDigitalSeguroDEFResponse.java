...
/**
 * <p>Clase Java para consultarInscripcionSelloDigitalSeguroDEFResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="consultarInscripcionSelloDigitalSeguroDEFResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "consultarInscripcionSelloDigitalSeguroDEFResponse", propOrder = {
    "_return"
})
public class ConsultarInscripcionSelloDigitalSeguroDEFResponse {
