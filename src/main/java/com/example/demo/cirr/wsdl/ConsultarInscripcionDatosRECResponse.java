...
/**
 * <p>Clase Java para consultarInscripcionDatosRECResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="consultarInscripcionDatosRECResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "consultarInscripcionDatosRECResponse", propOrder = {
    "_return"
})
public class ConsultarInscripcionDatosRECResponse {
